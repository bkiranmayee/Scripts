...
srun gunzip -c filtered_run2/filtered_run2.vcf.gz | perl ~/perl_toolchain/bed_cnv_fig_table_pipeline/tabFileColumnCounter.pl -f stdin -c 0 -o filtered_run2/v_per_chr -e '#'

srun gunzip -c filtered_run2/filtered_run2.vcf.gz | perl ~/perl_toolchain/bed_cnv_fig_table_pipeline/tabFileColumnCounter.pl -f stdin -c 0 -o filtered_run2/v_per_chr_m -e '#' -m &

srun sort -k1,1 -V -s filtered_run2/v_per_chr_m > filtered_run2/v_sorted_per_chr_m
...
srun Rscript --vanilla convertToRDS.R filtered_run2/filtered_run2.frq filtered_run2/filtered_run2.frq.rds 

srun Rscript --vanilla convertToRDS.R filtered_run2/filtered_run2.afreq filtered_run2/filtered_run2.afreq.rds

srun Rscript --vanilla convertToRDS.R filtered_run2/filtered_run2.lmiss filtered_run2/filtered_run2.lmiss.rds
...
srun Rscript --vanilla per_chr_plot.R /mnt/nfs/nfs1/derek.bickhart/CDDR-Project/vcfs/condensed_vcfs/liftover/annotated/combined_sorted_per_chr filtered_run2/v_sorted_per_chr filtered_run2/Variants_per_chrom_plot_run2.pdf

srun R -e "rmarkdown::render('summary_2.Rmd',output_file='filtered_run2/filtered_run2.html')"
