...
gwasresults1<-GWAS(pheno,geno,fixed=colnames(pheno)[2:4], K=NULL, n.PC=0, n.core>1, plot=TRUE)
gwasresults2<-GWAS(pheno,geno,fixed=colnames(pheno)[2:4], K=NULL, n.PC=2, n.core>1, plot=TRUE)
